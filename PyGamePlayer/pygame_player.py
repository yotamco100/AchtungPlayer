...
class PyGamePlayer(object):
    ...
    def get_ms_per_frame(self, event):
        return 1000.0 / self.force_game_fps

    def get_game_time_ms(self, event):
    ...
    def _on_screen_update(self, _, *args, **kwargs):
        ...
        self._game_time += self.get_ms_per_frame(None)
    ...
    class _FixedFPSClock(object):
        ...
        def tick(self, _=None):
            if self._pygame_player.run_real_time:
                ...
                return self._pygame_player.get_ms_per_frame(None)
        ...
        def get_time(self):
            return self._pygame_player.get_game_time_ms(None)

        def get_raw_time(self):
            return self._pygame_player.get_game_time_ms(None)

        def get_fps(self):
            return int(1.0 / self._pygame_player.get_ms_per_frame(None))
